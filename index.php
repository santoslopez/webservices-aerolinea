...
<body id="body-pd" style="margin-top:7%;margin-left:10%">
    ...
    <main class="main" style="width:95%;margin-right:20%;">
        ...
        <div class="tab-pane fade" id="viajes" role="tabpanel" aria-labelledby="viajes-tab" style="idth:100%">
            <div class="alert alert-primary" role="alert">
        ...
        <div class="tab-pane fade" id="webservices" role="tabpanel" aria-labelledby="webservices-tab" style="width:100%">
            <div class="alert alert-primary" role="alert">
                ...
                <a href="asientosW/script_lista_asientos.php">Ir script lista vuelos</a><br>
